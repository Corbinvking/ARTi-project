...
export const CreatorStatusTable = ({ 
  creators, 
  onStatusUpdate, 
  onBulkUpdate 
}: CreatorStatusTableProps) => {
  ...
  const [viewingNotesCreator, setViewingNotesCreator] = useState<CampaignCreator | null>(null);
  ...
  const handleQuickStatusUpdate = (creatorId: string, field: string, value: string) => {
    const updates: Partial<CampaignCreator> = {
      [field]: value
    };
    onStatusUpdate(creatorId, updates);
  };
        ...
        <Table className="min-w-[1000px]">
          <TableHeader>
            <TableRow>
              ...
              <TableHead className="min-w-[140px]">Post Status</TableHead>
              <TableHead className="min-w-[140px]">Approval Status</TableHead>
              ...
              <TableRow key={creator.id}>
                ...
                <TableCell>
                  <Select
                    ...
                    onValueChange={(value) => handleQuickStatusUpdate(creator.id, 'payment_status', value)}
                  >
                    <SelectTrigger className="w-32">
                ...
                <TableCell>
                  <Select
                    ...
                    onValueChange={(value) => handleQuickStatusUpdate(creator.id, 'post_status', value)}
                  >
                    <SelectTrigger className="w-32">
                ...
                <TableCell>
                  <Select
                    ...
                    onValueChange={(value) => handleQuickStatusUpdate(creator.id, 'approval_status', value)}
                  >
                    <SelectTrigger className="w-32">
                      ...
                      <Dialog>
                        <DialogTrigger asChild>
                          <Button 
                            ...
                            size="sm" 
                            title="View notes"
                            onClick={() => setViewingNotesCreator(creator)}
                          >
