import type { QBOCustomerResponse } from '../types.js';

/** Map a QBO Customer JSON object to our local table columns */
export function mapCustomer(raw: QBOCustomerResponse, connectionId: string) {
  return {
