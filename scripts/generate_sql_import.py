...
def generate_sql_from_scraped_data():
    ...
    for json_file in sorted(json_files):
        ...
        sql_statements.append(f"  v_campaign_id UUID;")
        sql_statements.append(f"BEGIN")
        sql_statements.append(f"  -- Find campaign and update SFA URL")
        ...
        sql_statements.append(f"  RETURNING id INTO v_campaign_id;")
        sql_statements.append(f"")
